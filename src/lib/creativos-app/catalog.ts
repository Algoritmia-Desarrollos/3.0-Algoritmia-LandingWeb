...
export const referencePresets: ReferencePreset[] = [
	{
		id: 'fiel',
		name: 'Fiel al ganador',
		description: 'Mantiene la jerarquía, el ritmo y la composición de la referencia.',
		label: 'Más segura',
	},
	{
		id: 'impacto',
		name: 'Más impacto',
		description: 'Sube contraste, tamaño de oferta y presencia del producto.',
		label: 'Alto scroll-stop',
	},
	{
		id: 'marca',
		name: 'Más marca',
		description: 'Conserva la estructura, pero prioriza identidad y coherencia visual.',
		label: 'Brand first',
	},
];
...
export const catalogTaxonomy: CatalogGroup[] = [
	{
		id: 'vender', label: 'Vender más', description: 'Ofertas, urgencia y razones para comprar hoy.', accent: '#ea580c', branches: [
	...
	{
		id: 'confianza', label: 'Generar confianza', description: 'Prueba social que baja el riesgo percibido.', accent: '#7c3aed', branches: [
	...
	{
		id: 'convencer', label: 'Convencer', description: 'Comparaciones que vuelven obvia la elección.', accent: '#dc2626', branches: [
	...
	{
		id: 'educar', label: 'Educar', description: 'Contenido que convierte atención en intención.', accent: '#0284c7', branches: [
	...
	{
		id: 'producto', label: 'Mostrar producto', description: 'Imágenes para explicar, demostrar y vender.', accent: '#059669', branches: [
	...
	{
		id: 'autoridad', label: 'Construir autoridad', description: 'Credenciales y relatos que hacen creíble tu marca.', accent: '#ca8a04', branches: [
