...
import { analyzeCatalogWithAI, scanInstagram, scanWebsite, type ScannedProduct, type ScannedSource } from '../../../lib/creativos-app/catalog-scanner';
import { normalizeExternalUrl, readLimited, safeExternalFetch } from '../../../lib/creativos-app/safe-fetch';
